...
console.log(extraerNumero(mesaSeleccionada));
          ...
          async function obtenerIdReservacion() {
            let url = "http://apicopacabana.com/reservaciones?columnas=idReservacion_reservacion";
            let init = {
              method: 'get',
              header: {
          ...
          async function obtenerYCrearReservacionData() {
            ...
            const apiUrl = 'http://apicopacabana.com/reservaciones'; // Reemplaza con la URL de tu API
